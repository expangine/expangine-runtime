...
export const TextOps = 
{
  ...
  soundex: ops.set('soundex', { complexity: 1 }, TextType, { value: TextType }, { max: NumberType, min: NumberType }),

  distance: ops.set('dist', { complexity: 1 }, NumberType, { value: TextType, test: TextType }),
