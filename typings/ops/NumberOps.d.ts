...
export declare const NumberOps: {
    ...
    min: import("../Operation").Operation<"b" | "a", never, never, never, never>;
    max: import("../Operation").Operation<"b" | "a", never, never, never, never>;
    ...
    hypot: import("../Operation").Operation<"b" | "a", never, never, never, never>;
    choose: import("../Operation").Operation<"k" | "n", never, never, never, never>;
    gcd: import("../Operation").Operation<"b" | "a", never, never, never, never>;
    bitAnd: import("../Operation").Operation<"b" | "a", never, never, never, never>;
    bitOr: import("../Operation").Operation<"b" | "a", never, never, never, never>;
    bitXor: import("../Operation").Operation<"b" | "a", never, never, never, never>;
