...
export declare const NumberOps: {
    ...
    toBaseText: import("../Operation").Operation<"value", "base" | "minDigits", never, "value" | "base" | "minDigits", "value" | "base" | "minDigits">;
    toText: import("../Operation").Operation<"value", "prefix" | "suffix" | "minPlaces" | "maxPlaces" | "useExponent" | "thousandSeparator", never, "value" | "prefix" | "suffix" | "minPlaces" | "maxPlaces" | "useExponent" | "thousandSeparator", "value" | "prefix" | "suffix" | "minPlaces" | "maxPlaces" | "useExponent" | "thousandSeparator">;
    isValid: import("../Operation").Operation<"value", never, never, never, never>;
    isZero: import("../Operation").Operation<"value", "epsilon", never, "value" | "epsilon", "value" | "epsilon">;
    isEqual: import("../Operation").Operation<"value" | "test", "epsilon", never, "value" | "test" | "epsilon", "value" | "test" | "epsilon">;
    isNotEqual: import("../Operation").Operation<"value" | "test", "epsilon", never, "value" | "test" | "epsilon", "value" | "test" | "epsilon">;
    ...
    isBetween: import("../Operation").Operation<"value" | "min" | "max", "minInclusive" | "maxInclusive", never, "value" | "min" | "max" | "minInclusive" | "maxInclusive", "value" | "min" | "max" | "minInclusive" | "maxInclusive">;
    isWhole: import("../Operation").Operation<"value", "epsilon", never, "value" | "epsilon", "value" | "epsilon">;
