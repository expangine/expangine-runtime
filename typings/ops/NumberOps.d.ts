...
export declare const NumberOps: {
    ...
    min: import("../Operation").OperationResolved<"b" | "a", never, never, never, never>;
    max: import("../Operation").OperationResolved<"b" | "a", never, never, never, never>;
    ...
    hypot: import("../Operation").OperationResolved<"b" | "a", never, never, never, never>;
    choose: import("../Operation").OperationResolved<"n" | "k", never, never, never, never>;
    gcd: import("../Operation").OperationResolved<"b" | "a", never, never, never, never>;
    bitAnd: import("../Operation").OperationResolved<"b" | "a", never, never, never, never>;
    bitOr: import("../Operation").OperationResolved<"b" | "a", never, never, never, never>;
    bitXor: import("../Operation").OperationResolved<"b" | "a", never, never, never, never>;
    ...
    isBetween: import("../Operation").OperationResolved<"value" | "max" | "min", "minInclusive" | "maxInclusive", never, never, never>;
