...
export declare const MapOps: {
    ...
    isEqual: import("../Operation").Operation<"value" | "test" | "isEqual", never, "value" | "key" | "test", "isEqual", never>;
    isNotEqual: import("../Operation").Operation<"value" | "test" | "isEqual", never, "value" | "key" | "test", "isEqual", never>;
    isLess: import("../Operation").Operation<"value" | "test" | "compare", never, "value" | "key" | "test", "compare", never>;
    isLessOrEqual: import("../Operation").Operation<"value" | "test" | "compare", never, "value" | "key" | "test", "compare", never>;
    isGreater: import("../Operation").Operation<"value" | "test" | "compare", never, "value" | "key" | "test", "compare", never>;
    isGreaterOrEqual: import("../Operation").Operation<"value" | "test" | "compare", never, "value" | "key" | "test", "compare", never>;
