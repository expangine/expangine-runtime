...
export declare const ListOps: {
    ...
    createLike: import("../Operation").Operation<"list", never, never, never, "list">;
    createFor: import("../Operation").Operation<"item", never, never, never, "item">;
    ...
    set: import("../Operation").Operation<"value" | "list" | "index", never, never, never, "list">;
    ...
    remove: import("../Operation").Operation<"list" | "isEqual" | "item", never, "value" | "list" | "test", "isEqual", "list">;
    ...
    clear: import("../Operation").Operation<"list", never, never, never, "list">;
    contains: import("../Operation").Operation<"list" | "isEqual" | "item", never, "value" | "list" | "test", "isEqual", never>;
    ...
    exclude: import("../Operation").Operation<"list" | "isEqual" | "exclude", never, "value" | "list" | "test", "isEqual", "list">;
    overlap: import("../Operation").Operation<"list" | "isEqual" | "overlap", never, "value" | "list" | "test", "isEqual", "list">;
    sort: import("../Operation").Operation<"list" | "compare", never, "value" | "list" | "test", "compare", "list">;
    shuffle: import("../Operation").Operation<"list", "times", never, never, "list">;
    unique: import("../Operation").Operation<"list" | "isEqual", never, "value" | "list" | "test", "isEqual", "list">;
    duplicates: import("../Operation").Operation<"list" | "isEqual", "once", "value" | "list" | "test", "isEqual", "list">;
    ...
    indexOf: import("../Operation").Operation<"list" | "isEqual" | "item", "start", "value" | "list" | "test", "isEqual", "list">;
    lastIndexOf: import("../Operation").Operation<"list" | "isEqual" | "item", "start", "value" | "list" | "test", "isEqual", "list">;
    ...
    cmp: import("../Operation").Operation<"value" | "test" | "compare", never, "value" | "list" | "test", "compare", never>;
    ...
    min: import("../Operation").Operation<"value" | "list", never, "list" | "item" | "index", "value", never>;
    max: import("../Operation").Operation<"value" | "list", never, "list" | "item" | "index", "value", never>;
    sum: import("../Operation").Operation<"value" | "list", never, "list" | "item" | "index", "value", never>;
    avg: import("../Operation").Operation<"value" | "list", never, "list" | "item" | "index", "value", never>;
    std: import("../Operation").Operation<"value" | "list", never, "list" | "item" | "index", "value", never>;
    variance: import("../Operation").Operation<"value" | "list", never, "list" | "item" | "index", "value", never>;
    median: import("../Operation").Operation<"value" | "list", never, "list" | "item" | "index", "value", never>;
    bitand: import("../Operation").Operation<"value" | "list", never, "list" | "item" | "index", "value", never>;
    bitor: import("../Operation").Operation<"value" | "list", never, "list" | "item" | "index", "value", never>;
    bitxor: import("../Operation").Operation<"value" | "list", never, "list" | "item" | "index", "value", never>;
    ...
    isEqual: import("../Operation").Operation<"list" | "test" | "isEqual", never, "value" | "list" | "test", "isEqual", never>;
    isNotEqual: import("../Operation").Operation<"list" | "test" | "isEqual", never, "value" | "list" | "test", "isEqual", never>;
    isLess: import("../Operation").Operation<"value" | "test" | "compare", never, "value" | "list" | "test", "compare", never>;
    isLessOrEqual: import("../Operation").Operation<"value" | "test" | "compare", never, "value" | "list" | "test", "compare", never>;
    isGreater: import("../Operation").Operation<"value" | "test" | "compare", never, "value" | "list" | "test", "compare", never>;
    isGreaterOrEqual: import("../Operation").Operation<"value" | "test" | "compare", never, "value" | "list" | "test", "compare", never>;
