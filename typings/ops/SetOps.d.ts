...
export declare const SetOps: {
    ...
    cmp: import("../Operation").Operation<"value" | "test" | "compare", never, "value" | "test", "compare", never>;
    ...
    isEqual: import("../Operation").Operation<"value" | "test" | "isEqual", never, "value" | "test", "isEqual", never>;
    isNotEqual: import("../Operation").Operation<"value" | "test" | "isEqual", never, "value" | "test", "isEqual", never>;
    isLess: import("../Operation").Operation<"value" | "test" | "compare", never, "value" | "test", "compare", never>;
    isLessOrEqual: import("../Operation").Operation<"value" | "test" | "compare", never, "value" | "test", "compare", never>;
    isGreater: import("../Operation").Operation<"value" | "test" | "compare", never, "value" | "test", "compare", never>;
    isGreaterOrEqual: import("../Operation").Operation<"value" | "test" | "compare", never, "value" | "test", "compare", never>;
