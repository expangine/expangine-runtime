export declare const NumberOpsTypes: {
    ...
    min: import("../..").OperationTypes<"b" | "a", never, never>;
    max: import("../..").OperationTypes<"b" | "a", never, never>;
    pow: import("../..").OperationTypes<"value" | "exponent", never, never>;
    atan2: import("../..").OperationTypes<"x" | "y", never, never>;
    hypot: import("../..").OperationTypes<"b" | "a", never, never>;
    choose: import("../..").OperationTypes<"n" | "k", never, never>;
    gcd: import("../..").OperationTypes<"b" | "a", never, never>;
    bitAnd: import("../..").OperationTypes<"b" | "a", never, never>;
    bitOr: import("../..").OperationTypes<"b" | "a", never, never>;
    bitXor: import("../..").OperationTypes<"b" | "a", never, never>;
    ...
    isBetween: import("../..").OperationTypes<"value" | "max" | "min", "minInclusive" | "maxInclusive", never>;
