...
export declare class Entity extends EventBase<EntityEvents> implements EntityOptions {
    ...
    getPropertyTypeFor(forProperty?: string): EnumType<any, any>;
    ...
    getEncodeExpected(forProperty?: string, defaultType?: Type): Type<any, any>;
    ...
    getDecodeExpected(forProperty?: string): Type<any, any>;
