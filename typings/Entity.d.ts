...
export declare class Entity extends EventBase<EntityEvents> implements EntityOptions {
    ...
    getPrimaryKeyExpression(separator?: string, name?: string): import(".").PathExpression | import(".").OperationExpression<"list", "delimiter" | "toText" | "prefix" | "suffix", "list" | "index" | "item">;
