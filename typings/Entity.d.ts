...
export declare class Entity extends EventBase<EntityEvents> implements EntityOptions {
    ...
    getPrimaryKeyExpression(separator?: string, name?: string): import(".").PathExpression | import(".").GetExpression | import(".").OperationExpression<"list", "toText" | "prefix" | "suffix" | "delimiter", "list" | "item" | "index">;
