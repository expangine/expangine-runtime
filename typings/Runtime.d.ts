...
export declare class Runtime {
    ...
    setOperation<R extends TypeInput, P extends TypeMap = any, O extends TypeMap = any, S extends TypeMap = any>(builder: OperationBuilder<any, R, P, O, S>, op: OperationToCommand<P, O, S>): void;
