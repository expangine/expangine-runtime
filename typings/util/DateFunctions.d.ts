...
export declare const adjusters: Record<string, Adjuster>;
export declare type Getter = (x: Date) => number;
export declare const getters: Record<string, Getter>;
export declare type Setter = (x: Date, value: number) => void;
export declare const setters: Record<string, Setter>;
...
export declare function getWeekIdentifier(x: Date): number;
export declare function getMonthIdentifier(x: Date): number;
export declare function getQuarterIdentifier(x: Date): number;
