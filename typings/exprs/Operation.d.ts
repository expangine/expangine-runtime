...
export declare class OperationExpression<P extends string = never, O extends string = never, S extends string = never> extends Expression {
    ...
    static create<P extends string, O extends string, S extends string, A extends S>(op: Operation<P, O, S, any, any>, params: Record<P, Expression> & Partial<Record<O, Expression>>, scopeAlias?: Record<A, string>): OperationExpression<P, O, S>;
    name: string;
    ...
    getParamTypes(def: DefinitionProvider, context: Type): TypeMapInput;
