...
export declare class Operations {
    ...
    set<P extends string = never, O extends string = never, S extends string = never, H extends (P | O) = never, R extends (P | O) = never>(localId: string, flags?: Partial<OperationFlags>, params?: P[], optional?: O[], scope?: S[], hasScope?: H[], resultDependency?: R[], loop?: boolean): OperationResolved<P, O, S, H, R>;
